...
def parse_args():
	...
	parser.add_argument('--data_dir', type=str, default='dataset/gaze360/imgs/', help='data directory')
...
scheduler = torch.optim.lr_scheduler.CyclicLR(optimizer, base_lr=1e-6, max_lr=1e-2,
...
for epoch in range(epochs):
	...
	if args.debug and epoch % 1 == 0:
		...
		test_debug_disp = debug_disp(model, test_dataloader, args.device)

		out_img = np.concatenate((train_debug_disp, valid_debug_disp, test_debug_disp), axis=1)
